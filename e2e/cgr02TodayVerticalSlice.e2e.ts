...
async function reviewedScreenshot(page: Page, name: string, fullPage = false) {
  ...
  const reviewNames = new Set(['quiet-today.png', 'decision-required.png', 'pending-save.png', 'unknown-save.png', 'offline-draft.png', 'conflict-save.png', 'cached-refresh-failure.png', 'single-390-200.png', 'single-320-200.png', 'capture-320-200.png', 'settings-320-200.png'])
