...
test('Gmail multi-event receipt projects into the real Today agenda and survives reload', async ({ page }) => {
  ...
  const body = '京东 AI产品经理 笔试通知：统一笔试时间2026年9月22日 09:00；京东 AI产品经理 面试通知：2026年9月23日 14:30参加面试'
