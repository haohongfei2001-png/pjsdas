...
- **Current condition:** production API and frontend both served exact integrated runtime `0c70dcc6780a0be4d2ba2623700b549a46ac9342` on 2026-09-24. No current-live CGR-04 source canary has run. Use the newest stable exact deployed main once the real authorized source transport and bounded evidence procedure are ready.
