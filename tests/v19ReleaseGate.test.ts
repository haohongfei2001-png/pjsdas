...
describe('v1.9 backend-first release gate', () => {
  it('refuses to publish GitHub Pages until one configured backend advertises the matching hardened v1.9 contract', () => {
    ...
    expect(workflow).toContain('No configured PJSDAS backend became ready')
  })
