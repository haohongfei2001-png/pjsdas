...
describe('source temporal resolution', () => {
  ...
  it('does not normalize impossible or ambiguous date/time expressions', () => {
    for (const text of ['2026-02-30 14:00', '2026-09-22或2026-09-23 14:00', '明天或后天 14:00', '明天 25:00', '明天 14:00 PST']) expect(resolveSourceTemporal(text, source)).toBeUndefined()
  })
